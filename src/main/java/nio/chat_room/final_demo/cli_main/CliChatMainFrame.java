package nio.chat_room.final_demo.cli_main;

import nio.chat_room.final_demo.NioClientService;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class CliChatMainFrame {
    ...
    NioClientService clientService;

    CliChatLoginFrame loginFrame;

    boolean isRun;

    public CliChatMainFrame(NioClientService clientService,CliChatLoginFrame loginFrame) throws HeadlessException {
