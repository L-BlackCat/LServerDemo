...
public class ChatClientRequestHandler_ChatLogout extends ChatClientRequestHandlerBase<RequestPacket> {

    public static final ChatClientRequestHandler_ChatLogout instance = new ChatClientRequestHandler_ChatLogout();
    @Override
